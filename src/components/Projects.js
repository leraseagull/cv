...
function Projects() {
        return (
            <div className="cards">
                ...
                <li className="card">
                        <a href="https://leraseagull.github.io/react-mesto-auth/" rel="noreferrer" target="_blank"><img src={Mesto} className="card__photo" alt="Фото проекта"/>
                        </a>
...
Медиазапросы, GitHub, Figma.
                    ...
                    <li className="card">
                    <a href="https://leraseagull.github.io/russian-travel/" rel="noreferrer" target="_blank"><img src={Путешествия} className="card__photo" alt="Фото проекта"/>
                        </a>
...
Nested, Flexbox/Grid, GitHub, Figma.</p>
                    ...
                    <li className="card">
                    <a href="https://leraseagull.github.io/calc-money/" rel="noreferrer" target="_blank"><img src={Конвертер} className="card__photo" alt="Фото проекта"/>
                        </a>
